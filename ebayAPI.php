...
<nav class="top-bar" data-topbar role="navigation">
  <ul class="title-area">
    <li class="name">
      <h1><a href="#">eBay Search Results</a></h1>
    </li>
  </ul>
 </nav>
</div>
<br>
<div class = "row">
<h3 class = "panel">This site displays auctions on eBay that have zero bids and are close to ending so you can get the lowest price possible on what you're looking for!</h3>
</div>
